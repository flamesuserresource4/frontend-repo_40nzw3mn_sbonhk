        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {tiers.map((tier) => (
            ...
            >
              ...
              <a
                href="#contact"
                className={`mt-6 inline-flex w-full items-center justify-center rounded-xl bg-gray-900/90 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-gray-900 ${tier.popular ? "bg-emerald-600 hover:bg-emerald-700" : ""}`}
              >
                {tier.cta}
              </a>
            </div>
