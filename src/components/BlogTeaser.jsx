      ...
      <div className="relative mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {posts.map((p, i) => (
            <article
              key={p.title}
              className="group rounded-2xl bg-gradient-to-br from-rose-50 via-pink-50 to-sky-50 p-6 ring-1 ring-rose-100/60 transition hover:shadow-sm"
            >
              ...
              <a href="#" className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-fuchsia-700">
