...
const posts = [
  ...
  },
  {
    ...
    excerpt:
      "How to reduce spreadsheet sprawl and build reliable audit trails with automation.",
    tag: "Automation",
  },
  {
    title: "Mapping frameworks: GRI, SASB, and ISSB",
    excerpt:
      "See how leading teams map disclosures across frameworks to avoid duplicate work.",
    tag: "Frameworks",
  },
];
    ...
    <section id="blog" className="relative">
      <div className="relative mx-auto max-w-6xl px-6 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-gray-600">Insights on sustainable reporting, automation, and assurance.</p>
        </div>

        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {posts.map((p) => (
            <article key={p.title} className="group rounded-2xl bg-gradient-to-br from-rose-50 to-amber-50 p-6 ring-1 ring-rose-100/60 transition hover:shadow-sm">
              <span className="inline-flex w-fit rounded-full bg-white/70 px-3 py-1 text-xs font-medium text-gray-700 ring-1 ring-gray-200">
                {p.tag}
              </span>
